...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _utils_solution_grid__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/solution_grid */ \"./js/utils/solution_grid.js\");\n/** Global config. */\n\n\n\nconst Config = {\n  width: 100,\n  height: 75,\n  player: {\n    startPosition: new THREE.Vector3(0, 0, 0)\n  },\n  world: {\n    cloudComplexity: 2,\n    offset: {\n      chapel: new THREE.Vector3(0, 0, 0),\n      turret: new THREE.Vector3(100, 0, 0),\n      observatory: new THREE.Vector3(0, 0, 100),\n      basement: new THREE.Vector3(-100, 0, 0),\n      garden: new THREE.Vector3(0, 0, -100)\n    }\n  },\n  lighting: {\n    sunlightDirection: new THREE.Vector3(0, -0.35, 1)\n  },\n  puzzle: {\n    grid: {\n      library: Object(_utils_solution_grid__WEBPACK_IMPORTED_MODULE_0__[\"GetRandomSolutionGrid\"])(16, 4),\n      basement: Object(_utils_solution_grid__WEBPACK_IMPORTED_MODULE_0__[\"GetRandomSolutionGrid\"])(16, 4),\n      observatory: Object(_utils_solution_grid__WEBPACK_IMPORTED_MODULE_0__[\"GetRandomSolutionGrid\"])(16, 4),\n      garden: Object(_utils_solution_grid__WEBPACK_IMPORTED_MODULE_0__[\"GetRandomSolutionGrid\"])(16, 4)\n    }\n  }\n};\n\n// create solution grid\nConfig.puzzle.grid.solution = new Array(64);\nObject(_utils_solution_grid__WEBPACK_IMPORTED_MODULE_0__[\"MapGrid\"])(Config.puzzle.grid.library, Config.puzzle.grid.solution, 0, 0, 4, 8);\nObject(_utils_solution_grid__WEBPACK_IMPORTED_MODULE_0__[\"MapGrid\"])(Config.puzzle.grid.basement, Config.puzzle.grid.solution, 4, 0, 4, 8);\nObject(_utils_solution_grid__WEBPACK_IMPORTED_MODULE_0__[\"MapGrid\"])(Config.puzzle.grid.observatory, Config.puzzle.grid.solution, 0, 4, 4, 8);\nObject(_utils_solution_grid__WEBPACK_IMPORTED_MODULE_0__[\"MapGrid\"])(Config.puzzle.grid.garden, Config.puzzle.grid.solution, 4, 4, 4, 8);\nConfig.puzzle.grid.chess = Object(_utils_solution_grid__WEBPACK_IMPORTED_MODULE_0__[\"GetExclusiveSolutionGrid\"])(64, 4, Config.puzzle.grid.solution);\nObject(_utils_solution_grid__WEBPACK_IMPORTED_MODULE_0__[\"MapGrid\"])(Config.puzzle.grid.chess, Config.puzzle.grid.solution, 0, 0, 8, 8, true);\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (Config);\n\n//# sourceURL=webpack://clouds/./js/config.js?");
...
/***/ "./js/lib/materials/cloud_material.js":
/*!********************************************!*\
  !*** ./js/lib/materials/cloud_material.js ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../config */ \"./js/config.js\");\n/* harmony import */ var _puzzle__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./puzzle */ \"./js/puzzles/puzzle.js\");\n/* harmony import */ var _ui_hotspot__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../ui/hotspot */ \"./js/ui/hotspot.js\");\n/* harmony import */ var _utils_tween__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/tween */ \"./js/utils/tween.js\");\n/* harmony import */ var _utils_solution_grid_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/solution_grid.js */ \"./js/utils/solution_grid.js\");\n/** Main puzzle. */\n\n\n\n\n\n\n\nclass PuzzleMainRoom extends _puzzle__WEBPACK_IMPORTED_MODULE_1__[\"default\"] {\n  constructor(root) {\n    super(root);\n    this.grid = _config__WEBPACK_IMPORTED_MODULE_0__[\"default\"].puzzle.grid;\n\n    // create floor grid\n    const group = new THREE.Group();\n    const size = 0.4;\n    const s = size * 0.75;\n    const left = -(size * 8 / 2);\n    const top = -left;\n    for (var i = 0, lim = this.grid.solution.length; i < lim; ++i) {\n      const mat = new THREE.MeshStandardMaterial({ color: 0x0 });\n      const mesh = new THREE.Mesh(new THREE.BoxBufferGeometry(s, s, s / 2), mat);\n      const hotspot = new _ui_hotspot__WEBPACK_IMPORTED_MODULE_2__[\"default\"](this.camera, { mesh: mesh, clickEvent: e => {\n          this.onGridItemClicked(e);\n        } });\n      const x = i % 8;\n      const y = (i - x) / 8;\n      mesh.position.set(left + x * size, top - y * size, 0);\n      this.hotspots.push(hotspot);\n      group.add(mesh);\n    }\n\n    // solution button\n    const mesh = new THREE.Mesh(new THREE.BoxBufferGeometry(1, s, s / 2), new THREE.MeshStandardMaterial({ color: 0x0 }));\n    const hotspot = new _ui_hotspot__WEBPACK_IMPORTED_MODULE_2__[\"default\"](this.camera, { mesh: mesh, clickEvent: () => {\n        this.checkSolution();\n      } });\n    this.hotspots.push(hotspot);\n    mesh.position.y = top + 0.5;\n    group.add(mesh);\n\n    group.position.y += top;\n    this.scene.add(group);\n  }\n\n  onGridItemClicked(e) {\n    e.disable();\n    const p1 = e.mesh.position.clone();\n    const p2 = p1.clone();\n    e.toggled = e.toggled === undefined ? true : e.toggled == false;\n    e.mesh.material.color.setHex(e.toggled ? 0xffffff : 0x0);\n    e.enable();\n  }\n\n  checkSolution() {\n    let correct = 0;\n    for (let i = 0, lim = 64; i < lim; ++i) {\n      const a = this.grid.solution[i] == 1;\n      const b = this.hotspots[i].toggled === undefined ? false : this.hotspots[i].toggled;\n      if (a == b) {\n        correct += 1;\n      }\n    }\n    console.log(correct);\n  }\n\n  printSolution() {\n    Object(_utils_solution_grid_js__WEBPACK_IMPORTED_MODULE_4__[\"PrintGrid\"])(this.grid.library, 4);\n    Object(_utils_solution_grid_js__WEBPACK_IMPORTED_MODULE_4__[\"PrintGrid\"])(this.grid.basement, 4);\n    Object(_utils_solution_grid_js__WEBPACK_IMPORTED_MODULE_4__[\"PrintGrid\"])(this.grid.observatory, 4);\n    Object(_utils_solution_grid_js__WEBPACK_IMPORTED_MODULE_4__[\"PrintGrid\"])(this.grid.garden, 4);\n    Object(_utils_solution_grid_js__WEBPACK_IMPORTED_MODULE_4__[\"PrintGrid\"])(this.grid.chess, 8);\n    Object(_utils_solution_grid_js__WEBPACK_IMPORTED_MODULE_4__[\"PrintGrid\"])(this.grid.solution, 8);\n\n    // check length = 20\n    /*\r\n    let count = 0;\r\n    for (let i=0, lim=this.grid.solution.length; i<lim; ++i) {\r\n      count += this.grid.solution[i];\r\n    }\r\n    console.log(count);\r\n    */\n  }\n\n  update(delta) {\n    this.updateHotspots();\n    this.updateTweens(delta);\n  }\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (PuzzleMainRoom);\n\n//# sourceURL=webpack://clouds/./js/puzzles/puzzle_main_room.js?");
