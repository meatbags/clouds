...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _utils_get_random_solution_grid__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/get_random_solution_grid */ \"./js/utils/get_random_solution_grid.js\");\n/** Global config. */\n\n\n\nconst Config = {\n  width: 100,\n  height: 75,\n  player: {\n    startPosition: new THREE.Vector3(4, 18, -8)\n  },\n  world: {\n    cloudComplexity: 0,\n    offset: {\n      turret: new THREE.Vector3(4, 17, -8),\n      library: new THREE.Vector3(0, 0, 0),\n      main: new THREE.Vector3(0, 0, 0),\n      observatory: new THREE.Vector3(0, 0, 0),\n      basement: new THREE.Vector3(0, 0, 0),\n      garden: new THREE.Vector3(0, 0, 0)\n    }\n  },\n  lighting: {\n    sunlightDirection: new THREE.Vector3(0, -0.35, 1)\n  },\n  puzzle: {\n    grid: {\n      library: Object(_utils_get_random_solution_grid__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(16, 4),\n      basement: Object(_utils_get_random_solution_grid__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(16, 4),\n      observatory: Object(_utils_get_random_solution_grid__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(16, 4),\n      garden: Object(_utils_get_random_solution_grid__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(16, 4)\n    }\n  }\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (Config);\n\n//# sourceURL=webpack://clouds/./js/config.js?");
...
/***/ "./js/utils/get_random_solution_grid.js":
/*!**********************************************!*\
  !*** ./js/utils/get_random_solution_grid.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/** Generate a random true/ false grid */\n\nconst GetRandomSolutionGrid = (size, n) => {\n  const res = new Array(size).fill(0);\n  while (n > 0) {\n    const index = Math.floor(Math.random() * size);\n    if (!res[index]) {\n      res[index] = 1;\n      n -= 1;\n    }\n  }\n  return res;\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (GetRandomSolutionGrid);\n\n//# sourceURL=webpack://clouds/./js/utils/get_random_solution_grid.js?");
